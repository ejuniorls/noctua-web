            ...
            <div class="min-h-screen flex flex-col lg:flex-row">
                ...
                <div class="flex w-full lg:w-1/3 items-center justify-center p-8">
                    <div class="w-full max-w-sm space-y-6">
                        ...
                        <p class="mb-6">Por favor, inscreva-se para continuar</p>
                        ...
                        <form class="space-y-4">
                            ...
                            <div>
                                <button type="submit" class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition">Cadastrar</button>
                            </div>
                        </form>
